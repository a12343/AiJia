package com.aijia.entity;


import com.aijia.support.EntityListener;
...
public class JpaBaseEntity extends BaseEntity {
    ...
    @Override
    @Id
    @GenericGenerator(name = "twitter-id", strategy = "com.seerbigdata.jpa.support.TwitterIdGenerator")
